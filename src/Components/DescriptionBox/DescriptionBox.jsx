    ...
    <div className="descriptionbox">
      ...
      <div className="descriptionbox-description">
        <p>
          ...
          buying and seiing of products or services over the internet it serves
          as a virtual marketplace where business and individuals can showcase
          ...
          and any avalabile vanations (eg, sizes, colors) Fach product usually has
